    ...
    return (
        <div>
            ...
            <div className='lg:px-36 px-2 background-color h-full lg:flex justify-between items-center'>
                <div >
                    <h1 className='text-[#1A1919] font-bold text-5xl lg:text-7xl'>You can <br /> find here Your <br /> <span className='text-color font-bold text-5xl lg:text-7xl'>Dream Job</span></h1>
